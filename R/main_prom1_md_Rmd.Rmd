...
plotReducedDim(sce.check, dimred="TSNE", colour_by ="PTPRS")
```
...
for (i in 1:(length(markers.patients))){
  ...
  for (j in 1:length(markers.patients[[i]])){
    ...
    write.table(markers.all[[i]][[j]], file= paste("/home/yue/hdd/yue/data/output/figures/PROM1/all_cluster_markers_seed6_1/",names(markers.patients)[i], j, ".csv", sep=""))
  }
...
markers.stem <- list(BT771_4=markers.all[["sce.BT771.total"]][["4"]], BT771_5=markers.all[["sce.BT771.total"]][["5"]], BT830_1 = markers.all[["sce.BT830.total"]][["1"]],
